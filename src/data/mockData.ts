...
export const mockProfiles = [
  {
    ...
    university: "MIT",
    contests: [
      { year: 2020, contest: "ICPC World Finals", position: 15 },
      { year: 2021, contest: "Google Code Jam", position: 8 },
      { year: 2022, contest: "Facebook Hacker Cup", position: 12 },
      { year: 2023, contest: "ICPC Regional", position: 3 },
    ],
    teams: [
      { name: "MIT Coders", year: 2020 },
      { name: "Algorithm Masters", year: 2021 },
      { name: "Code Warriors", year: 2022 },
    ]
  },
  {
    id: "2",
    ...
    university: "Stanford",
    contests: [
      { year: 2019, contest: "ICPC Regional", position: 5 },
      { year: 2020, contest: "Google Code Jam", position: 20 },
      { year: 2021, contest: "TopCoder Open", position: 7 },
    ],
    teams: [
      { name: "Stanford Stars", year: 2019 },
      { name: "Binary Beasts", year: 2020 },
    ]
  },
  {
    id: "3",
    ...
    university: "CMU",
    contests: [
      { year: 2021, contest: "ICPC World Finals", position: 25 },
      { year: 2022, contest: "Codeforces Round", position: 18 },
    ],
    teams: [
      { name: "CMU Champions", year: 2021 },
    ]
  }
];
