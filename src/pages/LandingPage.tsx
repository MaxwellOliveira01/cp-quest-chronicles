...
import { User, GraduationCap, Trophy, Users } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            ...
            universities, teams, and contests to see the achievements and progress of programmers worldwide.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          <Link to="/search/team" className="group">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Find competitive programming teams, see their members 
                  and track their contest participation history.
                </p>
              </div>
            </div>
          </Link>
